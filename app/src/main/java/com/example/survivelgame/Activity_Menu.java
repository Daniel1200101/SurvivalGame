package com.example.survivelgame;
...
public class Activity_Menu extends AppCompatActivity {
    ...
    public void startGame(String id, String data) {
        ...
        Intent intent = new Intent(getBaseContext(), com.example.survivelgame.Activity_Game.class);
        intent.putExtra(com.example.survivelgame.Activity_Game.EXTRA_ID, id);
        intent.putExtra(com.example.survivelgame.Activity_Game.EXTRA_STATE, state);
